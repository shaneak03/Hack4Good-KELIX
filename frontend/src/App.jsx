    ...
    <>
      ...
      <Router>
        <Routes>
          ...
          {isLoggedIn ? (
            <>
              <Route path="/" element={<><NavBar logo="https://via.placeholder.com/40" navItems={['Home', 'Products', 'About']} bankValue={300} /><HomePage /></>} />
              <Route path="/products" element={<><NavBar logo="https://via.placeholder.com/40" navItems={['Home', 'Products', 'About']} bankValue={300} /><ProductPage /></>} />
